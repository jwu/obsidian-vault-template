...
# 1. .agents/ — 全部同步
# ═══════════════════════════════════════════
info "1/7  .agents/ (全部同步)"
$RSYNC --delete "${WORK}/.agents/" "${TEMPLATE}/.agents/"

# ═══════════════════════════════════════════
# 2. .obsidian/ — 排除本地/个人部分
# ═══════════════════════════════════════════
info "2/7  .obsidian/ (排除本地部分)"
$RSYNC --delete \
...
# 3. .pi/ — 排除本地依赖
# ═══════════════════════════════════════════
info "3/7  .pi/ (排除 node_modules & lock)"
$RSYNC --delete \
...
# ═══════════════════════════════════════════
# 4. 99-system/ — 排除 cookie.md, work-with-me 脱敏
# ═══════════════════════════════════════════
info "4/7  99-system/ (排除 cookie.md, work-with-me 脱敏)"
...
# ═══════════════════════════════════════════
# 5. 根目录文件 — 排除 ABOUT-ME.md
# ═══════════════════════════════════════════
info "5/7  根目录文件 (排除 ABOUT-ME.md)"
...
# ═══════════════════════════════════════════
# 6. 内容目录 — 仅同步目录结构 + .gitkeep
# ═══════════════════════════════════════════
info "6/7  内容目录结构 (仅目录 + .gitkeep)"
...
# ═══════════════════════════════════════════
# 7. 清理模板中 work 不存在但 template 有的残留
# ═══════════════════════════════════════════
info "7/7  清理残留"
